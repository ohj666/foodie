...
public class CustomConnectionRepository  implements ConnectionRepository {
    ...
    private final CustomConnectionRepository.ServiceProviderConnectionMapper connectionMapper = new CustomConnectionRepository.ServiceProviderConnectionMapper();

    public CustomConnectionRepository(String userId, JdbcTemplate jdbcTemplate, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor, String tablePrefix) {
        this.userId = userId;
    ...
    public MultiValueMap<String, Connection<?>> findAllConnections() {
        ...
        Iterator i$ = registeredProviderIds.iterator();

        while(i$.hasNext()) {
            String registeredProviderId = (String)i$.next();
            connections.put(registeredProviderId, Collections.emptyList());
        }

        String providerId;
        Connection connection;
        for(i$ = resultList.iterator(); i$.hasNext(); connections.add(providerId, connection)) {
    ...
    private final class ServiceProviderConnectionMapper implements RowMapper<Connection<?>> {
        ...
        public Connection<?> mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            ConnectionFactory<?> connectionFactory = CustomConnectionRepository.this.connectionFactoryLocator.getConnectionFactory(connectionData.getProviderId());
        ...
        private String decrypt(String encryptedText) {
            return encryptedText != null ? CustomConnectionRepository.this.textEncryptor.decrypt(encryptedText) : encryptedText;
        }
