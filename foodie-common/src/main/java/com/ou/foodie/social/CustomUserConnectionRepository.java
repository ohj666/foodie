...
public class CustomUserConnectionRepository  implements UsersConnectionRepository {
    ...
    public CustomUserConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        if (userId == null) {
            ...
            return new CustomConnectionRepository(userId, this.jdbcTemplate, this.connectionFactoryLocator, this.textEncryptor, this.tablePrefix);
        }
    }
}
